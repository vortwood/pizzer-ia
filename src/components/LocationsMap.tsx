      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl sm:text-5xl lg:text-6xl font-semibold text-white mb-6 tracking-tight">
            <span className="text-gradient-orange">Maldonado</span> y{" "}
            <span className="text-gradient-orange">Punta del Este</span>
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
            Nuestras máquinas expendedoras automáticas de pizza 24/7 están
            disponibles en ubicaciones estratégicas de Maldonado y Punta del
            Este. Pizza caliente al instante, lista en 3 minutos, todos los días
            del año.
          </p>
        </div>
        ...
        <div className="text-center mt-28">
          <div className="glass-card p-8 max-w-3xl mx-auto">
            <h3 className="text-2xl font-semibold text-white mb-4">
              ¿Querés una{" "}
              <span className="text-gradient-orange">Máquina PizzerIA</span> en
              tu local?
            </h3>
            <p className="text-gray-400 mb-6">
              Estamos expandiendo con nuestro modelo de franquicia. Si tenés un
              negocio en Maldonado, Punta del Este o alrededores, contactanos
              para saber más sobre cómo agregar una máquina expendedora PizzerIA
              y generar ingresos pasivos 24/7.
            </p>
